/**
 * 模块职责：实现 coding-agent 源码模块「modes\interactive\components\tree-selector.ts」，负责相关命令行、会话、工具或基础设施逻辑。
 */
import {
	type Component,
	Container,
...
class TreeList implements Component {
	 ...
	 * 返回 the index in filteredNodes, or the last index as fallback.
	 */
